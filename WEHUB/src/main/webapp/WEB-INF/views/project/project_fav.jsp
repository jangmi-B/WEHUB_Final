...
<div class="index_section">
    ...
    <div class="projectWrap">
      ...
      <form action="${path}/project/favorite" method="get">
      	...
      	<c:forEach var="projectList" items="${projectList}" varStatus="status">
	        <div class="pojectdiv" id="projectDivNo${projectList.projectNo}">
	          ...
	          <div class="projectdivInfo pj${ status.count }">
	            ...
	            <a href="javascript:clickFav(${projectList.projectNo})" id="favBtn" class="favBtn${projectList.status}"><i class="fas fa-star"></i></a>
	          </div>
	        </div>
